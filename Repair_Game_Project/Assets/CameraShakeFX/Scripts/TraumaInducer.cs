...
public class TraumaInducer : MonoBehaviour 
{
    ...
    //{
       ...
       // GameController.s_Instance.stressReceiver.InduceStress(MaximumStress);
    //}

    public void SendTrauma(int amount = -1)
    {
        GameController.s_Instance.stressReceiver.InduceStress(amount == -1 ? MaximumStress : amount);
    }
